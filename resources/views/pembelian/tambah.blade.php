              ...
              <div class="col-md-6"> 
                <!-- general right form elements -->
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="total_harga_beli" id="total_harga_beli" class="form-control" placeholder="" value="{{$total_harga_beli}}" readonly >
                  </div>                           
                <!-- general right form elements -->
              </div>              
            </div>
            ...
            <div class="content table-responsive table-full-width" style="margin-left: -1%;">              
              ...
              <?php $i=1; foreach ($detailPembelian as $detailBarang):  ?>
                <tr>
                  ...
                  <td style="text-align: center;">Rp. {{$detailBarang->harga_beli}}</td>

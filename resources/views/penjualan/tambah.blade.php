                ...
                <!-- general left form elements  --> 
                 <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" name="total_harga_jual" id="total_harga_jual" class="form-control" placeholder="" value="{{$total_harga_jual}}" readonly >
                  </div> 
                  <!-- <div class="form-group">
            ...
            <div class="content table-responsive table-full-width" style="margin-left: -1%;">              
              ...
              <?php $i=1; foreach ($detailPenjualan as $detailBarang):  ?>
                <tr>
                  ...
                  <td style="text-align: center;">Rp. {{$detailBarang->harga_jual}}</td>                  
                  <td style="text-align: center;">{{$detailBarang->diskon}} %</td>
                  <td style="text-align: center;">Rp. {{$detailBarang->harga_jual_akhir}}</td>
                  <td style="text-align: center;">{{$detailBarang->jumlah_jual}}</td>
                  <td style="text-align: center;">Rp. {{$detailBarang->sub_total_harga}}</td>

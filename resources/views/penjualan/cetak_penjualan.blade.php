                ...
                <table class="transaction-table" cellspacing="0" cellpadding="0">                    
                    ...
                    <tbody>
                      ...
                      <tr>    
                        ...
                        <td style="text-align: center;">{{$value->diskon}}%</td>
                        <td style="text-align: center;">{{$value->harga_jual_akhir}}</td>
                    ...
                    <tr>
                        <td colspan="5" class="final-price">
                            TOTAL
                        </td>
                        <td class="final-price">
                             Rp. {{$penjualans->total_harga_jual}}
                        </td>
                    </tr>
                    <tr>
                        <td colspan="5" class="final-price">
